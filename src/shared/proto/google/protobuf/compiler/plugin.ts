...
export const CodeGeneratorRequest: MessageFns<CodeGeneratorRequest> = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 17: {
					...
					message.sourceFileDescriptors.push(
						FileDescriptorProto.decode(reader, reader.uint32()),
					);
					continue;
				}
	...
	fromJSON(object: any): CodeGeneratorRequest {
		return {
			fileToGenerate: globalThis.Array.isArray(object?.fileToGenerate)
				...
				: globalThis.Array.isArray(object?.file_to_generate)
			...
			protoFile: globalThis.Array.isArray(object?.protoFile)
				...
				: globalThis.Array.isArray(object?.proto_file)
					? object.proto_file.map((e: any) => FileDescriptorProto.fromJSON(e))
					: [],
			sourceFileDescriptors: globalThis.Array.isArray(
				object?.sourceFileDescriptors,
			)
				? object.sourceFileDescriptors.map((e: any) =>
						FileDescriptorProto.fromJSON(e),
					)
				: globalThis.Array.isArray(object?.source_file_descriptors)
					? object.source_file_descriptors.map((e: any) =>
							FileDescriptorProto.fromJSON(e),
						)
					: [],
			compilerVersion: isSet(object.compilerVersion)
				? Version.fromJSON(object.compilerVersion)
				: isSet(object.compiler_version)
					? Version.fromJSON(object.compiler_version)
					: undefined,
		};
	},
	...
	toJSON(message: CodeGeneratorRequest): unknown {
		...
		if (message.protoFile?.length) {
			obj.protoFile = message.protoFile.map((e) =>
				FileDescriptorProto.toJSON(e),
			);
		}
		if (message.sourceFileDescriptors?.length) {
			obj.sourceFileDescriptors = message.sourceFileDescriptors.map((e) =>
				FileDescriptorProto.toJSON(e),
			);
		}
		if (message.compilerVersion !== undefined) {
	...
	create<I extends Exact<DeepPartial<CodeGeneratorRequest>, I>>(
		base?: I,
	): CodeGeneratorRequest {
		return CodeGeneratorRequest.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<CodeGeneratorRequest>, I>>(
		object: I,
	): CodeGeneratorRequest {
		const message = createBaseCodeGeneratorRequest();
		...
		message.protoFile =
			object.protoFile?.map((e) => FileDescriptorProto.fromPartial(e)) || [];
		message.sourceFileDescriptors =
			object.sourceFileDescriptors?.map((e) =>
...
export const CodeGeneratorResponse: MessageFns<CodeGeneratorResponse> = {
	...
	fromJSON(object: any): CodeGeneratorResponse {
		return {
			...
			supportedFeatures: isSet(object.supportedFeatures)
				? globalThis.Number(object.supportedFeatures)
				: isSet(object.supported_features)
					? globalThis.Number(object.supported_features)
					: 0,
			minimumEdition: isSet(object.minimumEdition)
				? globalThis.Number(object.minimumEdition)
				: isSet(object.minimum_edition)
					? globalThis.Number(object.minimum_edition)
					: 0,
			maximumEdition: isSet(object.maximumEdition)
				? globalThis.Number(object.maximumEdition)
				: isSet(object.maximum_edition)
					? globalThis.Number(object.maximum_edition)
					: 0,
	...
	create<I extends Exact<DeepPartial<CodeGeneratorResponse>, I>>(
		base?: I,
	): CodeGeneratorResponse {
		return CodeGeneratorResponse.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<CodeGeneratorResponse>, I>>(
		object: I,
	): CodeGeneratorResponse {
		const message = createBaseCodeGeneratorResponse();
		...
		message.file =
			object.file?.map((e) => CodeGeneratorResponse_File.fromPartial(e)) || [];
		return message;
	},
};
...
export const CodeGeneratorResponse_File: MessageFns<CodeGeneratorResponse_File> =
	{
		...
		fromJSON(object: any): CodeGeneratorResponse_File {
			return {
				...
				insertionPoint: isSet(object.insertionPoint)
					? globalThis.String(object.insertionPoint)
					: isSet(object.insertion_point)
						? globalThis.String(object.insertion_point)
						: "",
				content: isSet(object.content) ? globalThis.String(object.content) : "",
				generatedCodeInfo: isSet(object.generatedCodeInfo)
					? GeneratedCodeInfo.fromJSON(object.generatedCodeInfo)
					: isSet(object.generated_code_info)
		...
		toJSON(message: CodeGeneratorResponse_File): unknown {
			...
			if (message.generatedCodeInfo !== undefined) {
				obj.generatedCodeInfo = GeneratedCodeInfo.toJSON(
					message.generatedCodeInfo,
				);
			}
			return obj;
		...
		create<I extends Exact<DeepPartial<CodeGeneratorResponse_File>, I>>(
			base?: I,
		): CodeGeneratorResponse_File {
			return CodeGeneratorResponse_File.fromPartial(base ?? ({} as any));
		},
		fromPartial<I extends Exact<DeepPartial<CodeGeneratorResponse_File>, I>>(
			object: I,
		): CodeGeneratorResponse_File {
			const message = createBaseCodeGeneratorResponse_File();
