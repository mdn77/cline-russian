...
export const GoFeatures: MessageFns<GoFeatures> = {
	...
	fromPartial<I extends Exact<DeepPartial<GoFeatures>, I>>(
		object: I,
	): GoFeatures {
		const message = createBaseGoFeatures();
...
export const GoFeatures_OptimizeModeFeature: MessageFns<GoFeatures_OptimizeModeFeature> =
	{
		...
		create<I extends Exact<DeepPartial<GoFeatures_OptimizeModeFeature>, I>>(
			base?: I,
		): GoFeatures_OptimizeModeFeature {
			return GoFeatures_OptimizeModeFeature.fromPartial(base ?? ({} as any));
		},
		fromPartial<
			I extends Exact<DeepPartial<GoFeatures_OptimizeModeFeature>, I>,
		>(_: I): GoFeatures_OptimizeModeFeature {
			const message = createBaseGoFeatures_OptimizeModeFeature();
			return message;
		},
	};
