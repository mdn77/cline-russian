	...
	implements EnvServiceClientInterface
{
	...
	subscribeToTelemetrySettings(
		...
		const stream: AsyncIterable<proto.host.TelemetrySettingsEvent> =
			client.subscribeToTelemetrySettings(request, {
	...
	implements WorkspaceServiceClientInterface
{
	protected createClient(
		channel: Channel,
	): niceGrpc.host.WorkspaceServiceClient {
	...
	saveOpenDocumentIfDirty(
		...
		return this.makeRequest((client) =>
			client.saveOpenDocumentIfDirty(request),
		);
	}
	getDiagnostics(
	...
	openInFileExplorerPanel(
		...
		return this.makeRequest((client) =>
			client.openInFileExplorerPanel(request),
		);
	}
	...
	executeCommandInTerminal(
		...
		return this.makeRequest((client) =>
			client.executeCommandInTerminal(request),
		);
	}
	openFolder(
	...
	searchWorkspaceItems(
		request: proto.host.SearchWorkspaceItemsRequest,
