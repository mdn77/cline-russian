...
export const WorkspaceServiceDefinition = {
	...
	methods: {
		...
		openClineSidebarPanel: {
			...
			requestType:
				OpenClineSidebarPanelRequest as typeof OpenClineSidebarPanelRequest,
			requestStream: false,
			responseType:
				OpenClineSidebarPanelResponse as typeof OpenClineSidebarPanelResponse,
			responseStream: false,
			options: {},
		},
		...
		searchWorkspaceItems: {
			...
			requestType:
				SearchWorkspaceItemsRequest as typeof SearchWorkspaceItemsRequest,
			requestStream: false,
			responseType:
				SearchWorkspaceItemsResponse as typeof SearchWorkspaceItemsResponse,
			responseStream: false,
			options: {},
		},
	},
...
export const WorkspaceServiceService = {
	...
	/** Opens and focuses the Cline sidebar panel in the host IDE. */
	openClineSidebarPanel: {
		path: "/host.WorkspaceService/openClineSidebarPanel" as const,
		requestStream: false as const,
		responseStream: false as const,
	 ...
	 */
	searchWorkspaceItems: {
		path: "/host.WorkspaceService/searchWorkspaceItems" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: SearchWorkspaceItemsRequest): Buffer =>
			Buffer.from(SearchWorkspaceItemsRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): SearchWorkspaceItemsRequest =>
			SearchWorkspaceItemsRequest.decode(value),
		responseSerialize: (value: SearchWorkspaceItemsResponse): Buffer =>
			Buffer.from(SearchWorkspaceItemsResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): SearchWorkspaceItemsResponse =>
			SearchWorkspaceItemsResponse.decode(value),
	},
} as const;
...
export interface WorkspaceServiceServer extends UntypedServiceImplementation {
	 ...
	 * this UNIMPLEMENTED so the caller can fall back to ripgrep.
	 */
	searchWorkspaceItems: handleUnaryCall<
		SearchWorkspaceItemsRequest,
		SearchWorkspaceItemsResponse
	>;
}
...
export interface WorkspaceServiceClient extends Client {
	...
	searchWorkspaceItems(
		...
		callback: (
			error: ServiceError | null,
			response: SearchWorkspaceItemsResponse,
		) => void,
	): ClientUnaryCall;
	searchWorkspaceItems(
		request: SearchWorkspaceItemsRequest,
