...
export const CommandsServiceService = {
	addToCline: {
		path: "/cline.CommandsService/addToCline" as const,
	...
	fixWithCline: {
		path: "/cline.CommandsService/fixWithCline" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
	...
	explainWithCline: {
		path: "/cline.CommandsService/explainWithCline" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
	...
	improveWithCline: {
		path: "/cline.CommandsService/improveWithCline" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: CommandContext): Buffer =>
			Buffer.from(CommandContext.encode(value).finish()),
