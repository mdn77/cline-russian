...
export const ClineRecommendedModel: MessageFns<ClineRecommendedModel> = {
	...
	create<I extends Exact<DeepPartial<ClineRecommendedModel>, I>>(
		base?: I,
	): ClineRecommendedModel {
...
export const ClineRecommendedModelsResponse: MessageFns<ClineRecommendedModelsResponse> =
	{
				...
				switch (tag >>> 3) {
					case 1: {
						...
						message.recommended.push(
							ClineRecommendedModel.decode(reader, reader.uint32()),
						);
						continue;
					}
					case 2: {
			...
			return {
				recommended: globalThis.Array.isArray(object?.recommended)
					? object.recommended.map((e: any) =>
							ClineRecommendedModel.fromJSON(e),
						)
					: [],
		...
		toJSON(message: ClineRecommendedModelsResponse): unknown {
			...
			if (message.recommended?.length) {
				obj.recommended = message.recommended.map((e) =>
					ClineRecommendedModel.toJSON(e),
				);
			}
		...
		fromPartial<
			I extends Exact<DeepPartial<ClineRecommendedModelsResponse>, I>,
		>(object: I): ClineRecommendedModelsResponse {
			const message = createBaseClineRecommendedModelsResponse();
			message.recommended =
				object.recommended?.map((e) => ClineRecommendedModel.fromPartial(e)) ||
				[];
			message.free =
				object.free?.map((e) => ClineRecommendedModel.fromPartial(e)) || [];
			return message;
		},
	};
...
export const ModelsServiceDefinition = {
	...
	methods: {
		...
		refreshClineRecommendedModelsRpc: {
			...
			requestStream: false,
			responseType:
				ClineRecommendedModelsResponse as typeof ClineRecommendedModelsResponse,
			responseStream: false,
			options: {},
		},
...
export const ModelsServiceService = {
	...
	/** Refreshes and returns Cline provider models */
	refreshClineModelsRpc: {
		path: "/cline.ModelsService/refreshClineModelsRpc" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
...
export interface ModelsServiceServer extends UntypedServiceImplementation {
	...
	>;
	/** Refreshes and returns recommended and free Cline models */
	refreshClineRecommendedModelsRpc: handleUnaryCall<
		EmptyRequest,
		ClineRecommendedModelsResponse
	>;
	/** Refreshes and returns Cline provider models */
	refreshClineModelsRpc: handleUnaryCall<
		EmptyRequest,
		OpenRouterCompatibleModelInfo
	>;
	/** Refreshes and returns Hugging Face models */
...
export interface ModelsServiceClient extends Client {
	...
	refreshClineRecommendedModelsRpc(
		...
		callback: (
			error: ServiceError | null,
			response: ClineRecommendedModelsResponse,
		) => void,
	): ClientUnaryCall;
	refreshClineRecommendedModelsRpc(
		request: EmptyRequest,
