...
export const CheckpointsServiceService = {
	checkpointDiff: {
		path: "/cline.CheckpointsService/checkpointDiff" as const,
	...
	subscribeToCheckpoints: {
		path: "/cline.CheckpointsService/subscribeToCheckpoints" as const,
		requestStream: false as const,
	...
	getCwdHash: {
		path: "/cline.CheckpointsService/getCwdHash" as const,
		requestStream: false as const,
		responseStream: false as const,
