...
export const BrowserServiceService = {
	getBrowserConnectionInfo: {
		path: "/cline.BrowserService/getBrowserConnectionInfo" as const,
	...
	testBrowserConnection: {
		path: "/cline.BrowserService/testBrowserConnection" as const,
		requestStream: false as const,
		responseStream: false as const,
	...
	discoverBrowser: {
		path: "/cline.BrowserService/discoverBrowser" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	getDetectedChromePath: {
		path: "/cline.BrowserService/getDetectedChromePath" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	relaunchChromeDebugMode: {
		path: "/cline.BrowserService/relaunchChromeDebugMode" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
