...
export const UiServiceDefinition = {
	...
	methods: {
		...
		subscribeToPartialMessage: {
			...
			requestType: EmptyRequest as typeof EmptyRequest,
			requestStream: false,
			responseType: ClineMessage as typeof ClineMessage,
			responseStream: true,
			options: {},
		},
...
export const UiServiceService = {
	/** Scrolls to a specific settings section in the settings view */
	scrollToSettings: {
		path: "/cline.UiService/scrollToSettings" as const,
	...
	/** Sets the terminal execution mode (vscodeTerminal or backgroundExec) */
	setTerminalExecutionMode: {
		path: "/cline.UiService/setTerminalExecutionMode" as const,
		requestStream: false as const,
		responseStream: false as const,
	...
	/** Marks the current announcement as shown and returns whether an announcement should still be shown */
	onDidShowAnnouncement: {
		path: "/cline.UiService/onDidShowAnnouncement" as const,
		requestStream: false as const,
		responseStream: false as const,
	...
	/** Subscribe to addToInput events (when user adds content via context menu) */
	subscribeToAddToInput: {
		path: "/cline.UiService/subscribeToAddToInput" as const,
		requestStream: false as const,
	...
	/** Subscribe to MCP button clicked events */
	subscribeToMcpButtonClicked: {
		path: "/cline.UiService/subscribeToMcpButtonClicked" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to history button click events */
	subscribeToHistoryButtonClicked: {
		path: "/cline.UiService/subscribeToHistoryButtonClicked" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to chat button clicked events (when the chat button is clicked in VSCode) */
	subscribeToChatButtonClicked: {
		path: "/cline.UiService/subscribeToChatButtonClicked" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to account button click events */
	subscribeToAccountButtonClicked: {
		path: "/cline.UiService/subscribeToAccountButtonClicked" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to settings button clicked events */
	subscribeToSettingsButtonClicked: {
		path: "/cline.UiService/subscribeToSettingsButtonClicked" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to worktrees button clicked events */
	subscribeToWorktreesButtonClicked: {
		path: "/cline.UiService/subscribeToWorktreesButtonClicked" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to partial message updates (streaming Cline messages as they're built) */
	subscribeToPartialMessage: {
		path: "/cline.UiService/subscribeToPartialMessage" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): EmptyRequest =>
			EmptyRequest.decode(value),
		responseSerialize: (value: ClineMessage): Buffer =>
			Buffer.from(ClineMessage.encode(value).finish()),
		responseDeserialize: (value: Buffer): ClineMessage =>
			ClineMessage.decode(value),
	},
	/** Initialize webview when it launches */
	initializeWebview: {
		path: "/cline.UiService/initializeWebview" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to relinquish control events */
	subscribeToRelinquishControl: {
		path: "/cline.UiService/subscribeToRelinquishControl" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Subscribe to show webview events */
	subscribeToShowWebview: {
		path: "/cline.UiService/subscribeToShowWebview" as const,
		requestStream: false as const,
		responseStream: true as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Returns the HTML for the webview index page. This is only used by external clients, not by the vscode webview. */
	getWebviewHtml: {
		path: "/cline.UiService/getWebviewHtml" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
	...
	/** Opens a URL in the default browser */
	openUrl: {
		path: "/cline.UiService/openUrl" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: StringRequest): Buffer =>
			Buffer.from(StringRequest.encode(value).finish()),
	...
	/** Opens the Cline walkthrough */
	openWalkthrough: {
		path: "/cline.UiService/openWalkthrough" as const,
		requestStream: false as const,
		responseStream: false as const,
		requestSerialize: (value: EmptyRequest): Buffer =>
			Buffer.from(EmptyRequest.encode(value).finish()),
