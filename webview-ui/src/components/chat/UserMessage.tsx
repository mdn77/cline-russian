					...
					<div style={{ display: "flex", gap: "8px", marginTop: "8px", justifyContent: "flex-end" }}>
						{!checkpointManagerErrorMessage && (
							<RestoreButton
								...
								title="Восстановить чат и файлы рабочей области до этой контрольной точки и отправить изменённое сообщение"
								type="taskAndWorkspace"
							/>
						)}
						<RestoreButton
							isPrimary={true}
							label="Восстановить чат"
							onClick={handleRestoreWorkspace}
							ref={restoreChatButtonRef}
							title="Восстановить только чат до этой контрольной точки и отправить изменённое сообщение"
							type="task"
						/>
					</div>
				</>
