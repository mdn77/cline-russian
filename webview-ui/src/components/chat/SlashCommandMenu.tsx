		...
		<div
			...
			<div
				...
				{filteredCommands.length > 0 ? (
					<>
						{renderCommandSection(defaultCommands, "Основные команды", 0, true)}
						{renderCommandSection(workflowCommands, "Команды рабочих процессов", defaultCommands.length, false)}
					...
					<div aria-selected="false" className="py-2 px-3 cursor-default flex flex-col" role="option">
						<div className="text-[0.85em] text-(--vscode-descriptionForeground)">Нет подходящих команд</div>
					</div>
				)}
			</div>
		</div>
