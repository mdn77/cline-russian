		...
		<div ref={modalRef}>
			...
			<div
				...
				<div className="mb-2.5 text-muted-foreground text-xs cursor-pointer" onClick={() => setIsVisible(false)}>
					Разрешить Cline выполнять эти действия без запроса подтверждения.{" "}
					<a
				...
				<div className="mt-1 text-xs text-muted-foreground">
					Уведомления могут показывать сокращённые сведения об инструментах для безопасности и конфиденциальности.
				</div>
			</div>
		</div>
	)
