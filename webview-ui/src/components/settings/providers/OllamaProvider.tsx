	...
	return (
		<div className="flex flex-col gap-2">
			<BaseUrlField
				...
				label="Использовать свой base URL"
				onChange={(value) => handleFieldChange("ollamaBaseUrl", value)}
				placeholder="По умолчанию: http://localhost:11434"
			/>
			...
			{apiConfiguration?.ollamaBaseUrl && (
				<ApiKeyField
					...
					placeholder="Введите API ключ (опционально)..."
					providerName="Ollama"
				/>
			)}
			...
			{showModelOptions && (
				<>
					<DebouncedTextField
						...
						placeholder="По умолчанию: 30000 (30 секунд)"
						style={{ width: "100%" }}>
