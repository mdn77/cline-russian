	...
	return (
		<div>
			{!ready ? (
				...
				<div>
					<div
						aria-label="Статус занятости Oracle"
						style={{
							marginTop: 12,
							marginBottom: 4,
						}}>
				...
				<div>
					...
					<div className="mt-0">
						<BaseUrlField
							...
							label="Свой Base URL (опционально)"
					...
					{isAuthenticated && ocaHasError && (
						<div
							...
							role="status">
							<div>Не удалось обновить модели. Проверьте сессию или сеть.</div>
