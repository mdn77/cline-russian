	...
	return (
		<div className="flex flex-col gap-1.5">
			<DebouncedTextField
				...
				placeholder="Введите AI Core Client Id..."
				style={{ width: "100%" }}
				type="password">
			...
			<DebouncedTextField
				...
				placeholder="Введите AI Core Client Secret..."
				style={{ width: "100%" }}
				type="password">
			...
			<DebouncedTextField
				...
				placeholder="Введите AI Core Base URL..."
				style={{ width: "100%" }}>
			...
			<DebouncedTextField
				...
				placeholder="Введите AI Core Auth URL..."
				style={{ width: "100%" }}>
			...
			<DebouncedTextField
				...
				placeholder="Введите AI Core Resource Group..."
				style={{ width: "100%" }}>
			...
			{showModelOptions && (
				<>
					<div className="flex flex-col gap-1.5">
						{isLoadingModels ? (
							<div className="text-xs text-(--vscode-descriptionForeground)">Загрузка моделей...</div>
						) : modelError ? (
